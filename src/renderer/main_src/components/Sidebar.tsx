    ...
    >
      <div
        style={{
          padding: '10px',
          cursor: 'pointer',
          color: props.active === 'main' ? '#ecf0f1' : '#7f8c8d'
        }}
      ...
      <div
        style={{
          padding: '10px',
          cursor: 'pointer',
          color: props.active === 'settings' ? '#ecf0f1' : '#7f8c8d'
        }}
      ...
      <div
        style={{
          padding: '10px',
          cursor: 'pointer',
          color: props.active === 'account' ? '#ecf0f1' : '#7f8c8d'
        }}
        onClick={() => props.setActive('account')}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <div
        style={{
          padding: '10px',
          cursor: 'pointer',
          color: props.active === 'impressum' ? '#ecf0f1' : '#7f8c8d'
        }}
        onClick={() => props.setActive('impressum')}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
